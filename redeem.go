...
//     envelopes* (which point at the issuer URL). /v1/issue mints
//     *session credentials* — completely separate code path, called
//     much more often, with attestation gating, HMAC binding, etc.
...
// facing message. Kept brief so the app can surface them in a
// snackbar without further translation.
