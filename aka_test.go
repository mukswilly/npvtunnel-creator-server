...
// Platform = ANDROID. iOS goes to App Attest when it
// lands; everything else falls through with a clear "not for me"
// verdict.
...
// the verified-boot gate alone. Headline 3.4e-iii integration check.
...
// TestIssueRequireTrustedRootRejectsUntrustedRoot — the headline
// 3.4e-ii integration check. With requireTrustedRoot set, a chain
...
// pre-3.4e-iii happy path). For tests that need a RootOfTrust, use
