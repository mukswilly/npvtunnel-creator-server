...
// With no imported registry, issuance fails instead of serving a constructed
// placeholder config.
func TestConfigsFileMissingRejectsIssuance(t *testing.T) {
	dir := t.TempDir()
	...
	req := buildSignedIssueRequest(t, devPriv, "anything")
