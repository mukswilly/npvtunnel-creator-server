...
//
// The honest UX replacement for the legacy whitebox-AES distribution
// flow: instead of "post a `.npvt` file in Telegram," the creator now
...
func runMintShareLinkSubcommand(args []string) int {
	...
	// every recipient's connect 404s — exactly the bug 3.6g fixes.
